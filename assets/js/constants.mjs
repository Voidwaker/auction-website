...
export const API_BASE = "https://v2.api.noroff.dev";  // Forsikre deg om at dette er riktig
export const API_AUTH = "/auth";
export const API_REGISTER = "/auth/register";  // Endret til riktig registreringsrute
